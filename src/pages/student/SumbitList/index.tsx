...
import { stuGetPros } from '../../../services/swagger/exam';
...
const columns: ProColumns<TableListItem>[] = [
  ...
  },
  {
    ...
    valueType: 'option',
    render: (_, record) => [
        <Link target = "_blank" to = {`./stuGetPro?tqid=${record.tqID}`}>详情</Link>,
      ],
  },
];
...
export default () => {
  ...
  return (
    <ProTable<TableListItem>
      ...
      toolBarRender={() => [
        <Link target = "_blank" to="./stuAddPro"><Button type="primary" key="primary">
          上传提交
        </Button></Link>,
      ]}
    />
